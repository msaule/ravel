...
- Provider capability discovery for hosted tools, MCP tools, and
  approval policies
- Ravel tool export surface for context summaries, model summaries,
  staged edits, and Quarto drafting
