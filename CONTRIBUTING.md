...
Ravel is not a generic chat wrapper. Contributions should improve at
...
- Do not imply that a consumer subscription exposes an API if it does
  not.
- Keep login-first and API-key support explicitly separated in docs and
  code.
